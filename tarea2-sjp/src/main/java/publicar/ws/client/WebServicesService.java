 ...
 * 
 */
@WebServiceClient(name = "WebServicesService", targetNamespace = "http://publicar/", wsdlLocation = "")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            String wsdlUrl = WebConfigHelper.getWebServicesWSDL();
            url = new URL(wsdlUrl);
        } catch (MalformedURLException e) {
            exception = new WebServiceException(e);
        }
        WEBSERVICESSERVICE_WSDL_LOCATION = url;
        WEBSERVICESSERVICE_EXCEPTION = null;
    }
